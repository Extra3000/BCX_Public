...
class HeatingDetailsPage extends StatefulWidget {
  const HeatingDetailsPage({Key? key}) : super(key: key);

  @override
  _HeatingDetailsPageState createState() => _HeatingDetailsPageState();
}

class _HeatingDetailsPageState extends State<HeatingDetailsPage> {
  double heating = 12;
  double fan = 15;
  @override
